...
<table class="document-header">
    <tr>
        ...
        <td class="document-title">
            ...
            <div class="meta">
                Émis le {{ $estimate->formattedEstimateDate }}<br>
                Valable jusqu’au {{ $estimate->formattedExpiryDate }}
            </div>
        </td>
    </tr>
</table>
...
@if ($estimate->reference_number)
    <div class="reference"><strong>Référence :</strong> {{ $estimate->reference_number }}</div>
@endif
...
<div class="footer">
    Document généré par AutoFacture — {{ $estimate->company->name }}
    @if ($estimate->company->siret) — SIRET {{ $estimate->company->siret }} @endif
    @if ($estimate->company->vat_number) — TVA {{ $estimate->company->vat_number }} @endif
</div>
</body>
</html>
