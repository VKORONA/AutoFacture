...
class InvoiceIntegrityServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        CreditNote::updating(function (): never {
            throw new DomainException('Un avoir émis est immuable.');
        });
        CreditNote::deleting(function (): never {
            throw new DomainException('Un avoir émis ne peut pas être supprimé.');
        });
        CreditNoteItem::updating(function (): never {
            throw new DomainException('Une ligne d’avoir émise est immuable.');
        });
        CreditNoteItem::deleting(function (): never {
            throw new DomainException('Une ligne d’avoir émise ne peut pas être supprimée.');
        });
    }
}
