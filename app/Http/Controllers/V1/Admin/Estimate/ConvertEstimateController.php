    ...
    public function __invoke(
        ...
        $invoice = DB::transaction(function () use ($companyId, $estimate, $invoice): Invoice {
            ...
            $invoice = Invoice::create([
                ...
                'reference_number' => $lockedEstimate->reference_number ?: $serial->getNextNumber(),
                'project_name' => $lockedEstimate->project_name,
                'project_address' => $lockedEstimate->project_address,
                'purchase_order_number' => $lockedEstimate->purchase_order_number,
                'project_contact' => $lockedEstimate->project_contact,
                'payment_terms_label' => $lockedEstimate->payment_terms_label,
                'show_sepa_qr' => (bool) $lockedEstimate->show_sepa_qr,
