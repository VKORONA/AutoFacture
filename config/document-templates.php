...
return [
    'invoices' => [
        [
            ...
            'theme' => 'premium',
            'preview' => 'img/document-templates/invoice-premium.svg',
        ],
        [
            'name' => 'invoice2',
            'label' => 'Classique Pro',
            ...
            'theme' => 'classic',
            'preview' => 'img/document-templates/invoice-classic.svg',
        ],
        [
            'name' => 'invoice3',
            ...
            'theme' => 'minimal',
            'preview' => 'img/document-templates/invoice-minimal.svg',
        ],
        [
            ...
            'theme' => 'standard',
            'preview' => 'img/document-templates/invoice-standard.svg',
        ],
        [
            'name' => 'franchise-tva',
            'label' => 'Franchise TVA',
            ...
            'theme' => 'franchise',
            'preview' => 'img/document-templates/invoice-franchise.svg',
        ],
    ],
    ...
    'estimates' => [
        [
            ...
            'theme' => 'premium',
            'preview' => 'img/document-templates/estimate-premium.svg',
        ],
        [
            'name' => 'estimate2',
            'label' => 'Classique Pro',
            ...
            'theme' => 'classic',
            'preview' => 'img/document-templates/estimate-classic.svg',
        ],
        [
            'name' => 'estimate3',
            'label' => 'Minimal élégant',
            ...
            'theme' => 'minimal',
            'preview' => 'img/document-templates/estimate-minimal.svg',
        ],
        [
            // La clé technique "nuit" est conservée pour ne pas casser les choix déjà enregistrés.
            'name' => 'nuit',
            ...
            'theme' => 'standard',
            'preview' => 'img/document-templates/estimate-standard.svg',
        ],
        [
            'name' => 'franchise-tva',
            'label' => 'Franchise TVA',
            ...
            'theme' => 'franchise',
            'preview' => 'img/document-templates/estimate-franchise.svg',
        ],
    ],
